            ...
            <Card className="w-full max-w-md shadow-2xl border-none rounded-[2.5rem] bg-white overflow-hidden">
                <CardHeader className="text-center space-y-6 pt-10 pb-2 relative">
                    ...
                    <div className="mx-auto block">
                        ...
                        <p className="text-[10px] tracking-[0.4em] text-[#64409a] mt-1 font-bold">PORTAIL EQUIPE</p>
                    </div>
                    <div className="w-16 h-16 rounded-3xl bg-[#64409a]/10 flex items-center justify-center mx-auto shadow-sm">
                        <Users className="h-8 w-8 text-[#64409a]" />
                    </div>
                    <CardTitle className="font-serif text-xl font-bold text-[#2a1f3d]">Espace Soins</CardTitle>
                </CardHeader>
                <CardContent className="p-8 pb-10">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            ...
                            >
                                <SelectTrigger className="h-14 rounded-2xl border-none bg-[#FBF9FF]/50 focus:ring-[#64409a]/30 text-base">
                        ...
                        <div className="mt-8 p-6 rounded-[1.8rem] bg-[#64409a]/5 border border-[#64409a]/10 text-center">
                            <p className="text-[10px] font-black text-[#64409a] uppercase tracking-widest mb-1">Accès Personnel</p>
